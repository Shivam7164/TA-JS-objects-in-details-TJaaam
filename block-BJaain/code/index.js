...
boundGetX(); // retrieveX is not defined
...
let person = new Person('John', 'Reed');
person.displayName(); // Name: Jhon Reed
let person2 = new Person('Paul', 'Adams');
person2.displayName(); // Name: Paul Adams
...
// Window {0: Window, window: Window, self: Window, document: document, name: '', location: Location, …} 'first this'
// Window {0: Window, window: Window, self: Window, document: document, name: '', location: Location, …} 'first this'
// Window {0: Window, window: Window, self: Window, document: document, name: '', location: Location, …} 'first this'
// [2, 4, 6]
object.doubleArrow();
...
// {data: Array(3), dataDouble: Array(3), double: ƒ, doubleArrow: ƒ}
// {data: Array(3), dataDouble: Array(3), double: ƒ, doubleArrow: ƒ} 'second this'
// {data: Array(3), dataDouble: Array(3), double: ƒ, doubleArrow: ƒ} 'second this'
// {data: Array(3), dataDouble: Array(3), double: ƒ, doubleArrow: ƒ} 'second this'
// (3) [2, 4, 6]
